<?php
	...
	function run() {
        ...
        add_action( 'plugins_loaded','rml_scripts');
        add_action( 'plugins_loaded','rml_styles');
		
		// Setup filter hook to show Read Me Later link
		add_filter( 'the_excerpt','rml_button');
		add_filter( 'the_content','rml_button');
