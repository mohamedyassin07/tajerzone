...
function create_smsa_bills($parent_order_id)
{
    ...
    foreach ($orders as $order_id) {
        ...
        $dataHelper = get_option('woocommerce_smsa_settings');
        ...
        $payment_method = $order->get_payment_method();
            ...
            $data = [
                'passKey' => get_option('woocommerce_smsa_settings')['passkey'] ,
                'refNo' => $order->get_id() ,
                ...
                'sContact' => get_option('woocommerce_smsa_settings')['shipper_contact'] ,
