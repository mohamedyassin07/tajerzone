...
function aramex_display_order_data_in_admin($order)
{
    ...
    // prr($get_userdata);
    if (!$get_userdata->allcaps['edit_shop_orders'] ) {
        return false;
    }
    ...
    ?>
<!-- Aramex shipment -->
<div id="Aramex-shipment" style="clear:both; padding-top:10px;">
    <a class=' button-primary dokan-btn' style="margin-top:15px;  display:none; "
...
<?php
    ...
    if( !empty($settings->settings['allowed_international_methods']) ){
...
<div id="aramex_overlay">
    <div id="aramex_shipment_creation">
        ...
        <form id="aramex_shipment" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>"
            ...
            <input name="aramex_shipment_shipper_account_pin" type="hidden"
                value="<?php echo esc_attr($account_pin); ?>" />
            <input name="aramex_shipment_shipper_account_cod" type="hidden"
                value="<?php echo esc_attr($cod_account_number); ?>" />
            <input name="aramex_shipment_shipper_account_pin_cod" type="hidden"
                value="<?php echo esc_attr($cod_account_pin); ?>" />

            <input name="aramex_shipment_original_reference" type="hidden" value="<?php echo esc_attr($order_id); ?>" />
            <FIELDSET class="aramex_shipment_creation_fieldset_big" id="aramex_shipment_creation_general_info">
                ...
                ?>
                    ...
                    <div class="cal-rate-button" style="float:right;">
                        ...
                        <?php if ($aramex_return_button === true) { ?>
                        <a class='button-primary print_aramex_shipment dokan-btn'
                            id="print_aramex_shipment"><?php echo esc_html__('Print Label', 'aramex'); ?> </a>
                        <?php } ?>
                    </div>
            </FIELDSET>
                ...
                <div id="shipper_details" class="aramex_shipment_creation_part">
                    <div class="text_short">
                        <label><?php echo esc_html__('Reference', 'aramex'); ?></label><input class="number" type="text"
                            name="aramex_shipment_shipper_reference" value="<?php echo esc_attr($order_id) ?>" />
                    </div>
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Name', 'aramex'); ?> <span class="red">*</span></label><input
                            type="text" class="required" id="aramex_shipment_shipper_name"
                            name="aramex_shipment_shipper_name" value="<?php echo esc_attr($name1); ?>" />
                    </div>
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Email', 'aramex'); ?> <span class="red">*</span></label><input
                            type="text" class="required email" id="aramex_shipment_shipper_email"
                            name="aramex_shipment_shipper_email" value="<?php echo esc_attr($email1); ?>" />
                    </div>
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Company', 'aramex'); ?></label><input type="text"
                            id="aramex_shipment_shipper_company" name="aramex_shipment_shipper_company"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Address', 'aramex'); ?> <span
                                class="red">*</span></label><textarea rows="4" class="required" cols="26" type="text"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('City', 'aramex'); ?> <span
                                class="red no-display">*</span></label><input class="aramex_city" autocomplete="off"
                            type="text" id="aramex_shipment_shipper_city" name="aramex_shipment_shipper_city"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Postal Code', 'aramex'); ?> <span
                            ...
                            id="aramex_shipment_shipper_postal" name="aramex_shipment_shipper_postal"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('State', 'aramex'); ?></label><input type="text"
                            id="aramex_shipment_shipper_state" name="aramex_shipment_shipper_state"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Phone', 'aramex'); ?></label><input class="required" type="text"
                            id="aramex_shipment_shipper_phone" name="aramex_shipment_shipper_phone"
                            value="<?php echo esc_attr($phone1); ?>" />
                    </div>
                </div>
            </FIELDSET>
            <!--  Receiver Details -->
            <FIELDSET class="aramex_shipment_creation_fieldset aramex_shipment_creation_fieldset_right">
                ...
                <div class="text_short">
                    <label><?php echo esc_html__('Reference', 'aramex'); ?></label><input class="number" type="text"
                        id="aramex_shipment_receiver_reference" name="aramex_shipment_receiver_reference"
    ...
    $name1 = $name1 . " " . $name_last1; ?>
                    ...
                    <label><?php echo esc_html__('Name', 'aramex'); ?>
                        ...
                        id="aramex_shipment_receiver_name" name="aramex_shipment_receiver_name"
                        value="<?php echo esc_attr($name1); ?>" />
                </div>
                <div class="text_short">
                    <?php $email_reciver1 = ($session) ? $_SESSION['form_data']['aramex_shipment_receiver_email'] : $email_reciver; ?>
                    <label><?php echo esc_html__('Email', 'aramex'); ?> <span class="red">*</span></label><input
                        class="email required" type="text" id="aramex_shipment_receiver_email"
                        name="aramex_shipment_receiver_email" value="<?php echo esc_attr($email_reciver1); ?>" />
                </div>
                <div class="text_short">
                    ...
                    <label><?php echo esc_html__('Company', 'aramex'); ?></label><input type="text"
                        id="aramex_shipment_receiver_company" name="aramex_shipment_receiver_company"
                ...
                <div class="text_short">
                    ...
                    <label><?php echo esc_html__('Address', 'aramex'); ?> <span class="red">*</span></label><textarea
                        class="required" rows="4" cols="26" type="text" id="aramex_shipment_receiver_street"
                ...
                <div class="text_short">
                    ...
                    <select class="aramex_countries" id="aramex_shipment_receiver_country"
                        ...
                        <option value="<?php echo $key ?>"
                            <?php echo ($country1 == $key) ? 'selected="selected"' : ''; ?>>
                            <?php echo esc_html($value); ?></option>
                        <?php
                ...
                <div class="text_short">
                    ...
                    <label><?php echo esc_html__('City', 'aramex'); ?>
                        ...
                        type="text" id="aramex_shipment_receiver_city" name="aramex_shipment_receiver_city"
                ...
                <div class="text_short">
                    ...
                    <label><?php echo esc_html__('Postal Code', 'aramex'); ?> <span
                            class="red no-display">*</span></label><input type="text" class=""
                        id="aramex_shipment_receiver_postal" name="aramex_shipment_receiver_postal"
                ...
                <div class="text_short">
                    ...
                    <label><?php echo esc_html__('State', 'aramex'); ?></label><input type="text"
                        id="aramex_shipment_receiver_state" name="aramex_shipment_receiver_state"
                        value="<?php echo esc_attr($state1); ?>" />
                </div>
                <div class="text_short">
                    <?php $phone_reciver1 = ($session) ? $_SESSION['form_data']['aramex_shipment_receiver_phone'] : $phone_reciver; ?>
                    <label><?php echo esc_html__('Phone', 'aramex'); ?></label><input class="required" type="text"
                        id="aramex_shipment_receiver_phone" name="aramex_shipment_receiver_phone"
                ...
                <div id="shipment_infromation" class="aramex_shipment_creation_part">
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Reference', 'aramex'); ?></label><input type="text"
                            id="aramex_shipment_info_reference" name="aramex_shipment_info_reference"
                            value="<?php echo esc_attr($order_id) ?>" />
                    </div>
                    <div class="text_short">
    ...
    if (isset($_SESSION['form_data']['aramex_shipment_info_product_group']) && $_SESSION['form_data']['aramex_shipment_info_product_group'] == "EXP") {
        $checkCountry = false;
                        ...
                        <select class="aramex_all_options" id="aramex_shipment_info_product_group"
                            ...
                            <option <?php echo ($checkCountry == true) ? 'selected="selected"' : ''; ?> value="DOM">
                                <?php echo esc_html__('Domestic', 'aramex'); ?>
                            </option>
                            <option <?php echo ($checkCountry == false) ? 'selected="selected"' : ''; ?> value="EXP">
                                <?php echo esc_html__('International Express', 'aramex'); ?>
                            </option>
                        </select>
                    ...
                    <div class="text_short">
                        ...
                        <select class="aramex_all_options" id="aramex_shipment_info_product_type"
                            ...
                            <option <?php echo $selected_str; ?> value="<?php echo esc_attr($key); ?>"
                                id="<?php echo esc_attr($key); ?>" class="DOM"><?php echo esc_html($val); ?></option>
                            <?php
                            ...
                            <option <?php echo $selected_str; ?> value="<?php echo esc_attr($key); ?>"
                                id="<?php echo esc_attr($key); ?>" class="EXP"><?php echo esc_html($val); ?></option>
                            <?php
                    ...
                    <div class="text_short">
                        ...
                        <select class="aramex_all_options" id="aramex_shipment_info_service_type"
                            name="aramex_shipment_info_service_type[]" multiple style="height:120px;">
                            <option value=""></option>
                            <?php
                            ...
                            <option <?php
                                ...
                                id="dom_as_<?php echo esc_attr($key); ?>" class="DOM local">
                            ...
                            <option <?php
                                ...
                                id="exp_as_<?php echo esc_attr($key); ?>" class="non-local EXP">
                                <?php echo esc_html($val); ?></option>
                            <?php
    ...
    $amount1 = ($checkCountry === true)? $amount1 : ""; ?>
                        ...
                        <label><?php echo esc_html__('COD Amount', 'aramex'); ?></label><input class="" type="text"
                            id="aramex_shipment_info_cod_amount" name="aramex_shipment_info_cod_amount"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Custom Amount', 'aramex'); ?></label><input class="" type="text"
                            id="aramex_shipment_info_custom_amount" name="aramex_shipment_info_custom_amount"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Cash Additional Amount ', 'aramex'); ?></label><input type="text"
                            class="" id="aramex_shipment_info_cash_additional_amount"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Insurance Amount', 'aramex'); ?></label><input type="text"
                            id="insurance_amount" name="insurance_amount"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('COD Currency', 'aramex'); ?></label><input type="text" class=""
                            id="aramex_shipment_currency_code" name="aramex_shipment_currency_code"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Customs Currency', 'aramex'); ?></label><input type="text"
                            class="" id="aramex_shipment_currency_code_custom"
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Comment', 'aramex'); ?></label><textarea rows="4" cols="<?php if (strpos($_SERVER['HTTP_USER_AGENT'],
                                                                                                       'Firefox')) {
        ?>29 <?php 
    } else {
        ?>35<?php 
                    ...
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Foreign Shipment No', 'aramex'); ?></label><input class=""
                            type="text" id="aramex_shipment_info_foreignhawb" name="aramex_shipment_info_foreignhawb"
                    ...
                    <div class="text_short">
                        <label><?php echo esc_html__('Items Price', 'aramex'); ?></label><input type="text"
                            id="aramex_shipment_info_items_subtotal" name="aramex_shipment_info_items_subtotal"
                            disabled="disabled" style="width: 165px; float: left;"
                            value="<?php echo esc_attr($order->get_total()); ?>" />

                        <div style="float: left; padding-left: 5px;"><?php echo esc_html(get_woocommerce_currency()); ?>
                        </div>
                    </div>
                    <div class="text_short">
                        ...
                        <label><?php echo esc_html__('Number of Pieces', 'aramex'); ?></label><input type="text"
                            name="number_pieces" value="<?php echo esc_attr($aramex_number_pieces); ?>"
    ...
    foreach ($order->get_items() as $item) {
        $product1 = wc_get_product($item['product_id']);?>
                                <tr id="item<?php echo $item['product_id'] ?>" class="aramex_item_tobe_shipped">
                                    <td></td>
                                    <td class="aramex_item_name">
                                        <span title="<?php echo esc_attr($item['name']); ?>"><?php echo esc_html(substr($item['name'],
                                                                0, 21)); ?>
                                            ...</span>
                                        <input type="hidden"
    ...
    if ($aramex_return_button) {
        ...
        ?>
                ...
                <button id="aramex_shipment_creation_submit_id" type="submit" name="aramex_shipment_creation_submit"
...
(function($) {
    ...
    function resetShipperDetail(el) {
        ...
        if (elValue == 2) {
            ...
            if (flag = 1) {
                ...
                document.getElementById('aramex_shipment_receiver_company').value =
                aramex_shipment_receiver_company;
                document.getElementById('aramex_shipment_receiver_street').value = aramex_shipment_receiver_street;
                document.getElementById('aramex_shipment_receiver_country').value =
    ...
    $("input[name=aramex_shipment_info_shipping_charges]").change(function() {
        var cod_value = parseFloat($("input[name=aramex_shipment_info_shipping_charges]").val()) +
            parseFloat($("input[name=aramex_shipment_info_items_subtotal]").val());
    ...
    $("#aramex_shipment_info_product_group").change(function() {
        ...
        if ($("select[name=aramex_shipment_info_product_group]").val() == 'EXP') {
            $("select[name=aramex_shipment_info_additional_services] option:selected").removeAttr(
                "selected");
            $("select[name=aramex_shipment_info_additional_services] .express_service").attr("selected",
                "selected");
            ...
            $("select[name=aramex_shipment_info_additional_services] option:selected").removeAttr(
                "selected");
            $("select[name=aramex_shipment_info_additional_services] .domestic_service").attr("selected",
                "selected");
            $("#aramex_shipment_info_product_type option").hide();

        }
        $("#aramex_shipment_info_service_type_div").html($(
            "select[name=aramex_shipment_info_service_type] option:selected").text());
        $("#aramex_shipment_info_additional_services_div").html($(
            "select[name=aramex_shipment_info_additional_services] option:selected").text());

    });
    $("#aramex_shipment_info_product_group_div").html($(
        "select[name=aramex_shipment_info_product_group] option:selected").text());
    $("#aramex_shipment_info_service_type_div").html($(
        "select[name=aramex_shipment_info_service_type] option:selected").text());
    $("#aramex_shipment_info_additional_services_div").html($(
        "select[name=aramex_shipment_info_additional_services] option:selected").text());
    ...
    $(document).ready(function() {
        ...
        $(function() {
            $("#aramex_shipment_info_pickup_date").datepicker({
                dateFormat: "yy-mm-dd"
            });
            $("#aramex_shipment_info_ready_time").datepicker({
                dateFormat: "yy-mm-dd"
            });
            $("#aramex_shipment_info_last_pickup_time").datepicker({
                dateFormat: "yy-mm-dd"
            });
            $("#aramex_shipment_info_closing_time").datepicker({
                dateFormat: "yy-mm-dd"
            });
        });
...
jQuery(document).ready(function() {
    ...
    function setAutocomplate(type) {
        ...
        function getAllCitiesJson(type, aramexCitiesObj) {
            ...
            var _wpnonce =
                "<?php echo esc_js(wp_create_nonce('aramex-shipment-check' . wp_get_current_user()->user_email)); ?>";


            var url_check = "<?php echo admin_url('admin-ajax.php'); ?>?country_code=" + country_code +
                '&_wpnonce=' + _wpnonce + "&action=the_aramex_searchautocities&backend=backend";
